...
const Navbar = () => {
  ...
  return (
    <div className='max-w-[420px] sm:max-w-[600px] md:max-w-[720px] lg:max-w-[840px] xl:max-w-[1100px] 2xl:max-w-[1440px] w-full max-h-[100px] flex justify-around px-8 items-center mx-auto mt-5 bg-black/30 rounded-xl border border-gray-100 shadow-lg'>
      ...
      <div>
        ...
        {/* Overlay */}
        <div className={nav ? 'w-screen h-screen absolute top-0 left-0 bg-black/40 md:hidden' : ''}></div>

        <div className={nav ? 'flex flex-col items-end absolute bg-gray-200 top-0 right-0 w-[200px] sm:w-[300px] p-4 h-screen md:hidden' : 'hidden'}>
