  ...
  return (
    <div className='max-w-[1260px] w-full max-h-[100px] flex justify-between items-center mx-auto mt-5 px-2 bg-black/30 rounded-xl border border-gray-100 shadow-lg'>
      ...
      <div>
        ...
        {/* Overlay */}
        <div className={nav ? 'w-screen h-screen absolute top-0 left-0 bg-black/40' : 'hidden'}></div>

        <div className={nav ? 'flex flex-col items-end absolute bg-gray-200 top-0 right-0 w-[200px] sm:w-[300px] p-4 h-screen' : 'hidden'}>
